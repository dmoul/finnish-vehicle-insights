...
Finland, a country with small population of about 5.6M in 2023^[[*Finland in Figures 2023 – key figures about us*](https://tilastokeskus.fi/uutinen/finland-in-figures-2023-key-figures-about-us) Statistics Finland. Published 2023-06-01], offers a convenient window into larger trends in passenger vehicles. Using three data sets I downloaded from the Finnish Transport and Communications Agency [Trafficom](https://traficom.fi/en) I explore the following questions:
...
Thanks to the Finnish Transport and Communications Agency Trafficom for making the data available at [Data.Traficom](https://tieto.traficom.fi/en).

Photo on this page by John Lloyd^[Photo: <https://flickr.com/photos/hugo90/42693172685/> licensed CC BY 2.0 DEED]

Hat tip to Jeremy Signer-Vine for [Data Is Plural](https://www.data-is-plural.com), where I learned about Traficom open data.
